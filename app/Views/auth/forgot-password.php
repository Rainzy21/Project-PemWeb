...
<body class="bg-[#E6EEFA] min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white rounded-2xl shadow-xl w-full max-w-[450px] p-8 md:p-10">
        ...
        <div class="text-center mb-8">
            <h1 class="text-2xl font-semibold text-gray-900 mb-2">Lupa Password?</h1>
            <p class="text-gray-500 text-sm">Masukkan email Anda dan admin akan membantu mereset password</p>
        </div>
        ...
        <!-- Form -->
        <form action="<?= BASE_URL ?>auth/doForgotPassword" method="POST" class="space-y-5">
            <div>
            ...
            <button type="submit" class="w-full bg-[#020617] hover:bg-gray-800 text-white font-medium py-3 rounded-lg transition duration-200">
                Kirim Permintaan
            </button>
        </form>
        ...
        <div class="text-center mt-6">
            <a href="<?= BASE_URL ?>auth/login" class="text-gray-400 text-sm hover:text-gray-600">← Kembali ke Login</a>
        </div>
    </div>
